...
import 'package:myhomestay_raya/models/product.dart';
import 'package:myhomestay_raya/detailsscreen.dart';
import 'package:myhomestay_raya/loginscreen.dart';
import 'package:myhomestay_raya/newproduct.dart';
...
//check permission,get location,get address return false if any problem.
  ...
  void _loadProducts() {
    ...
    http
        .get(
      Uri.parse(
          "${Config.SERVER}/php/loadseller.php?userid=${widget.user.id}"),
    )
        .then((response) {
